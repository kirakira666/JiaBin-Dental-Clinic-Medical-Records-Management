    ...
    <view class="u-demo-wrap" style="background-color: #ffffff;">
      ...
      <view class="u-demo-area">
        <u-collapse event-type="close" :arrow="true" :accordion="true" @change="change">
          <u-collapse-item :index="index" @change="itemChange" :title="item.head" v-for="(item, index) in itemList"
            :key="index">
            <u-collapse :item-style="itemStyle" event-type="close" :arrow="false" :accordion="true" @change="change2">
              <u-collapse-item :index="ind" @change="itemChange" :title="item.body[ind]" v-for="(item2, ind) in item.body"
                :key="ind">
              </u-collapse-item>
            </u-collapse>
          </u-collapse-item>
